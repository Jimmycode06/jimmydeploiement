...
export const products = [
  {
    ...
    thumbnail: "/images/sidefolio-aceternity-2.png", // Chemin relatif depuis public/
    images: [
    ...
    content: (
      <div>
        <Image
          src="/images/sidefolio-aceternity-2.png"
          alt="Aceternity Thumbnail"
          width={500} // Définis la largeur de l'image
          height={300} // Définis la hauteur de l'image
        />
        <p>
  ...
  },
  {
    ...
    content: (
      <div>
        <Image
          src="/images/sidefolio-moonbeam.png"
          alt="Moonbeam Thumbnail"
          width={500}
          height={300}
        />
        <p>
  ...
  },
  {
    ...
    content: (
      <div>
        <Image
          src="/images/sidefolio-tailwindmasterkit.png"
          alt="Tailwind Master Kit Thumbnail"
          width={500}
          height={300}
        />
        <p>
